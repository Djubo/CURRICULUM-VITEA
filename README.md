...
src="https://icon-library.net//images/twitch-icon-png/twitch-icon-png-0.jpg" alt="Twitch"></a></p>           
 ...
 <div>
  ...
  <h5>-STEF: Agent de quai ( 2 ans )</h5>
    ...
    <div style="width:100%;height:0;padding-bottom:56%;position:relative;"><iframe src="https://giphy.com/embed/2wW2RcJfffMxpyXDzi" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div><p><a href="https://giphy.com/gifs/simonloosbv-warehouse-logistics-warehousing-2wW2RcJfffMxpyXDzi">via GIPHY</a></p>
</p></div>        
  </body>
<htlm>
